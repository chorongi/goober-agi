...
class AGIBenchmark:
    ...
    def run_task1(self, fetcher: StreamFetcher) -> float:
        ...
        predicted_chat = self.llm.predict_future_chat(history_video.frames, history_chat)
    ...
    def run_task2(self, fetcher: StreamFetcher) -> float:
        ...
        score = self.evaluator.evaluate_task2(predicted_frames, true_video.frames, chat_context)
